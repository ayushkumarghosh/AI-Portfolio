      ...
      <div className="container mx-auto py-12 px-4 md:px-6">
        ...
        <div className="mt-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card className="card-hover border border-secondary/20 animate-fade-in animate-delay-500">
              <CardContent className="p-6">
            ...
            <Card className="card-hover border border-secondary/20 animate-fade-in animate-delay-600">
              <CardContent className="p-6">
