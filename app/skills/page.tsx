    ...
    <>
      ...
      <div className={`page-transition-wrapper ${isLoaded ? 'loaded' : ''}`}>
        <div className="container mx-auto py-12 px-4 md:px-6">
          ...
          <div className="mt-12">
            <h2 className="text-2xl font-bold mb-6 text-primary">Additional Skills</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <Card id="dev-practices" className="card-hover border border-secondary/20">
                <CardContent className="p-6">
              ...
              <Card id="ai-ml" className="card-hover border border-secondary/20">
                <CardContent className="p-6">
